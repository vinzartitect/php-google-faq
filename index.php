...
riscrivere la pagina delle faq del sito google.
ci sono diverse domande con relative risposte.
gestire il database e la visualizzazione di queste domande e risposte in php.
...
<body>
    ...
    <main>
        <?php
            // imposto il primo foreach padre inerente a tutte le faqs
            foreach ($faqs as $questionBlock) {
                echo '<div class="question">';
                // imposto il foreach figlio inerente alle singole faq
                foreach ($questionBlock as $questionKey => $questionValue) {
                    // se la key è uguale a question 
                    if ($questionKey === "question") {
                        // mi stampa il suo valore
                        echo "<h4>" . $questionValue . "</h4>";
                        // mentre se la key è uguale a answers
                    } else if ($questionKey === "answers") {
                        // faccio un altro foreach figlio inerente alle sottofaq
                        foreach ($questionValue as $subKey => $subValue) {
                            // stampo il valore delle singole sottofaq
                            echo '<p>' . $subValue . '</p>';
                        }
                    }
                };
